    ...
    for i, return_dict in enumerate(test_loader):
        ...
        for i in range(target_var.size(0)):
            ...
            for ind in pred_index:
                ...
                cut_img, sure_fg, sure_bg = watershed_cut(img_path, grayscale_cams, save_dir,
                                                          image_name[:-4] + '_ind' + str(ind) + '.png')
...
if __name__ == '__main__':
    ...
    save_dir = r"D:\MasterKagioglou\Pascal_VOC\RESULTS_resnet50_cbam_Jon\watershed_sb09_sf01"
